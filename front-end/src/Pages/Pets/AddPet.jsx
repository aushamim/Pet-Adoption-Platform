...
const handleSubmit = (e, APIHost, navigate, userId, loadPets) => {
  e.preventDefault();
  ...
  toast.promise(promise, {
    loading: "Adding Pet. Please wait.",
    ...
    <div className="mt-10 xl:mt-16 bg-white pt-8 xl:pt-14 pb-10 xl:pb-24 bg-opacity-80 rounded-lg shadow">
      ...
      >
        ...
        <div className="mt-8 flex justify-end items-center">
          <input className="btn-purple ml-3" type="submit" value="Add" />
        </div>
      </form>
    </div>
  );
